...
export default function Slider({ title }) {
  return (
    <View style={[tw`bg-white rounded-lg w-52 h-36 m-2`, globalStyles.shadow]}>
      <View style={[tw`rounded-t-lg p-2`, { backgroundColor: "#013B4F" }]}>
        <Text style={tw`text-white text-lg text-center`}>{title}</Text>
      </View>

      <View
        style={tw`flex-row justify-center rounded-full m-4 mx-3`}
      >
      ...
      <View
        style={tw`flex-row justify-center rounded-full drop-shadow-xl m-1 mx-4`}
      >
